...
function ac_onfocus(event, a_idInput, a_idForm, a_searchAction, a_minCharacter, a_nextElementToFocus, a_inputClassOk, a_inputClassKo, a_afterHide, a_inputClassWait, a_additionalFormInputs,
		a_showAllOnEmptyField)
{
